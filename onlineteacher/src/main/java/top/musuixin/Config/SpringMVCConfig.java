...
public class SpringMVCConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/addCourse").setViewName("addCourse.html");
        registry.addViewController("/index").setViewName("index.html");
        registry.addViewController("/courseList").setViewName("courseList.html");
        registry.addViewController("/upCourse").setViewName("upCourse.html");
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(myInterceptorLogin).addPathPatterns("/index","/courseList",
                "/addCourse","/upCourse","/user","/newslist");
